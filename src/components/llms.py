...
class BaseLLM(ABC):
    ...
    def chat_llm(
        ...
        *,
        ...
        has_stream=False,
        **kwargs
    ) -> Generator[tuple[None, None, dict[str, int]] | tuple[None, None, dict[str, Any]] | tuple[str | None, None, None] | tuple[str, None, dict[str, int]] | tuple[None, list, dict[str, Any]], Any, None]:
        pass
...
class GenericLLM:
    ...
    def from_groq_llama3_1_8b(api_key, use_cache=False):
        ...
        return BaseGenericLLM(api_key=api_key, base_url=base_url, default_model_name=model_name, default_headers=default_headers)
...
class BaseGenericLLM(BaseLLM):
    def __init__(self, api_key, base_url=None, *, default_model_name, default_headers = None) -> None:
